  ...
  return (
    <div>
      ...
      <div className="scroll-container">
            ...
            <div class="hero-container">
              ...
              <div class="hero-visual">
                <p class="hero-card-text">
                  Borrow against your savings without a credit score.
                  <br />
        ...
        <section className="golden-thread-section">
          <div className="section-inner">
        ...
        <section className="compliance-section">
          <div className="section-inner">
            ...
            <p>
              We operate under strict FCA/PRA guidelines for Collective
              Investment Schemes (CIS). Your funds are managed with the highest
          ...
          <div className="section-inner">
            <div className="subscribe-container">
              ...
              <p className="subscribe-subtitle">
                Join thousands of others in the ethical finance revolution.
              </p>
