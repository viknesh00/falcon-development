...
const InputField = ({ icon, type, name, placeholder, error, touched, isReactIcon = false, iconAsset }) => (
        ...
        <div className={`${Styles.inputWrapper} ${error && touched ? Styles.error : ''}`}>
            {iconAsset !== null && (
                isReactIcon ? (
                    ...
                    <div className={Styles.icon}><img src={iconAsset} alt="" className={Styles.iconAsset} /></div>
                ) : icon ? (
...
const PhoneInputField = ({ iconAsset, name, placeholder, error, touched, value, onChange, onBlur }) => (
    <div className={Styles.formGroup}>
        <div className={`${Styles.inputWrapper} ${Styles.phoneInputWrapper} ${error && touched ? Styles.error : ''}`}>
    ...
    if (step === 4) {
        return (
            <div className={Styles.authContainer}>
                ...
                <main className={Styles.mainContent} style={{ gridTemplateColumns: '1fr', justifyContent: 'center' }}>
                    <div className={`${Styles.successContainer} ${Styles.fadeIn}`}>
                        <h1 className={Styles.successTitle}>Account ready</h1>
                        <p className={Styles.successMessage}>
                            We're setting up your Falcon account.
                        </p>
                    </div>
                    ...
                    <div className={Styles.loadingSection}>
                        <h2 className={Styles.title} style={{ fontSize: '32px' }}>{dynamicContent[loadingIndex]}</h2>
            ...
            <main className={Styles.mainContent}>
                <section className={`${Styles.formSection} ${Styles.fadeIn}`}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', width: '100%', marginBottom: '40px' }}>
                        <div>
                            {step === 1 && <h1 className={Styles.title}>Create your Falcon<br />account</h1>}
                            {step === 1.5 && <h1 className={Styles.title}>Create your Falcon<br />account</h1>}
                            {step === 2 && <h1 className={Styles.title}>Personal & financial<br />details</h1>}
                    ...
                    >
                        {({ errors, touched, values, setFieldValue }) => (
                            <Form className={Styles.formGrid}>
                                {step === 1 && (
                                    <>
                                        <p className={Styles.subTitle}>Set up your account to start using Shariah-compliant financial services.</p>
                                        ...
                                        <p className={Styles.termsText}>
                                            By continuing, you agree to Falcon's <a href="#">Terms and Conditions</a>. <br />
                                ...
                                {step === 2 && (
                                    <>
                                        <p className={Styles.subTitle}>Tell us a bit about yourself. This helps us serve you responsibly.</p>
                                ...
                                {step === 3 && (
                                    <>
                                        ...
                                        <div className={Styles.uploadWrapper}>
                                            ...
                                            <p className={Styles.uploadText}>Photo ID upload (Passport / Driving licence)</p>
                                            <img src={UploadIcon} alt="" className={Styles.uploadActionIcon} style={{ transform: 'rotate(0deg)' }} />
                                        </div>
                ...
                <section className={Styles.illustrationContainer}>
                    <div className={Styles.illustrationSection}>
                        <img src={OnBoardingVector} alt="Falcon Illustration" className={Styles.illustration} />
                    </div>
                </section>
            </main>
