...
// Hooks
import useCamera from '../../../domains/auth/presentation/hooks/useCamera';
import useFaceModel from '../../../domains/auth/presentation/hooks/useFaceModel';
import useFaceDeduction from '../../../domains/auth/presentation/hooks/useFaceDeduction';
    ...
    try {
      ...
      if (model && isModelLoaded) {
        try {
          ...
          const svc = await import('../../../domains/auth/infrastructure/faceDetectionService');
